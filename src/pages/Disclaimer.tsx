          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none space-y-6">
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  Any AI-generated stock picks or analyses on this platform are provided for informational purposes only. 
                  These predictions are based on algorithmic analysis and should not be considered as recommendations to 
                  buy, sell, or hold any securities. Always conduct your own research before making investment decisions.
                </p>
              </section>
