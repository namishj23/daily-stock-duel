            ...
            <div className="prose prose-invert max-w-none space-y-6">
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
                  ...
                  <li>Predictions must be submitted between 9:00 AM and 9:30 AM IST</li>
                  <li>Only NSE Top 100 stocks are eligible for prediction</li>
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  ...
                  is the property of StockPredict and is protected by Indian and international copyright laws.
                </p>
              </section>
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  StockPredict shall not be liable for any indirect, incidental, special, consequential, or 
                  punitive damages resulting from your use of or inability to use the platform. Our total 
                  liability shall not exceed the amount of prizes won by you in the preceding 12 months.
                </p>
              </section>
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  StockPredict reserves the right to modify these terms at any time. Users will be notified 
