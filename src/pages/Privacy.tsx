          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none space-y-6">
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  We retain your account information for as long as your account is active. Prediction data 
                  may be retained indefinitely for statistical and historical purposes, even after account deletion, 
              ...
              <section className="p-6 rounded-2xl bg-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  StockPredict is not intended for users under 18 years of age. We do not knowingly collect 
